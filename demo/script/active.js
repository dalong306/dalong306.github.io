                   ...
                   touchmove: function(e){
                          ...
                          var self = this;
                             ...
                             //判断最小值 与最大值 
                              ...
                              self.ulW > self.wW && self.setTransform(self.dx, 0)
                      ...
                      var self = this;
                          ...
                          if(!self.isMove){//点击触发操作
                             e.preventDefault();
                                  ...
                                  //索引定位 
                                 setTimeout(scrollTo, 0, 0, (Math.floor(index/2) * (self.floorOddH + self.floorEvenH))
                                                           + (index % 2 * self.floorEvenH) 
                                                           + self.tabTop + 2);
                                ...
                                if(self.moveReady){//移动到左边极限与右边极限回归位置
                                    ...
                                    self.ulW > self.wW && self.setTransform(self.moveDis, 350)
                                }   
                          }
